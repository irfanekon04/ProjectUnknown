      ...
      <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-between ">
        ...
        <div className="relative w-full md:w-1/2 mx-auto flex flex-col items-center">
          ...
          <div className="w-full md:w-[440px]">
            <img
              className="rounded-2xl w-[440px] hidden md:block md:absolute md:top-0 md:left-[2rem]"
          ...
          {/* Bottom Image */}
          <div className="w-full md:w-[296px] mt-6 hidden md:block md:absolute md:left-[-4rem] md:top-[195px]">
            <img
        ...
        <div className="flex flex-col items-center mx-auto md:w-1/2 mt-12 md:mt-0">
          ...
          <h1 className="font-bold text-3xl md:text-4xl text-[#192239] text-center">Who We Are?</h1>
