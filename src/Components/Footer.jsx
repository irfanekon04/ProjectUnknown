  ...
  return (
    <div className="max-w-screen-xl mx-auto">
      <footer className="footer bg-base-100 text-base-content p-10">
        ...
        <nav>
          <h6 className="footer-title opacity-100 text-gray-800">Features</h6>
        ...
        <nav>
          <h6 className="footer-title opacity-100 text-gray-800">Products</h6>
        ...
        <nav>
          <h6 className="footer-title opacity-100 text-gray-800">Support</h6>
